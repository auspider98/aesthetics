    ...
    },
    {
      ...
      "sections": [
        ...
        },
        {
          ...
          "background": "inherit",
          "anchorId": "richtext-2",
          "richContent": "<h2 style=\"\">The Benefits: Beyond the Scale</h2><div>While clinical studies show that patients lose an average of 15% to 20% of their total body weight when combining these weekly shots with lifestyle modifications, the health benefits extend far beyond a number on the scale:</div><div><ul><li>Cardiovascular Protection: Clinical updates confirm that GLP-1 therapies significantly lower the risk of major adverse cardiac events, such as heart attacks and strokes.</li><li>Joint and Sleep Improvement: Shedding excess weight relieves chronic joint pain and drastically reduces symptoms of obstructive sleep apnea.</li><li>First-Line Medical Consensus: The American College of Physicians (ACP) officially recommends semaglutide and tirzepatide as the premier, first-line medical interventions for adult obesity.</li></ul></div>",
        ...
        },
        {
          ...
          "items": [
            ...
            },
            {
              "title": "",
              "body": "",
              "imagePath": "images/weightloss/weight-loss-beforeafter-05.jpg",
              "bgColor": "",
              "fullBleed": true,
              "textColor": "dark",
              "btnLabel": "",
